...
//Κλάση για την εμφάνιση των συνολικών εξόδων της εταιρίας για συγκεκριμένο έτος μέσω γραφικής διεπαφής
public class CompExpensesWindow {
    ...
    CompExpensesWindow(Company c){ //είσοδος του object company διαμέσο του Constructor
        ...
        String [] colNames = {"Year","Annual Company Expenses"};
        ...
        dataVal[0][0] = "2018";
        dataVal[0][1] = String.valueOf(c.calculateAnnualCompanyExpenses(2018));
        dataVal[1][0] = "2019";
        dataVal[1][1] = String.valueOf(c.calculateAnnualCompanyExpenses(2019));
        dataVal[2][0] = "2020";
        dataVal[2][1] = String.valueOf(c.calculateAnnualCompanyExpenses(2020));
